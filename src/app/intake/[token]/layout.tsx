...
export const metadata: Metadata = {
  title: "Patient Intake | ClaimFlow Medical",
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-semibold text-slate-900">ClaimFlow Medical</h1>
              <p className="text-xs text-slate-500">Secure Patient Intake</p>
            </div>
          </div>
        </div>
      </header>
